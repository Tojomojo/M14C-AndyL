// Dependencies
// Express.js connection established
...
router.get('/', (req, res) => {
    ...
    Post.findAll({
        ...
        // Order the posts from most recent to least recent
        order: [[ 'created_at', 'DESC']],
        // From the User table, include the post creator's username
        // From the Comment table, include all comments posted
        include: [
            {
                model: User,
                attributes: ['username']
    ...
    // if there was a server error, return the error message
    .catch(err => {
        console.log(err);
