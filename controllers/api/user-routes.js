...
router.post('/', (req, res) => {
  // create method
  // expects an object in the form {username: 'John Doe', email: 'JohnDoe@gmail.com', password: 'password012345'}
  User.create({
...
router.put('/:id', withAuth, (req, res) => {
    // update method to expects {username: 'Lernantino', email: 'lernantino@gmail.com', password: 'password1234'}
